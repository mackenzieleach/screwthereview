      ...
      <Container fluid id="page-container">
        <Row className="align-items-center">
          ...
          <Col id="landing_col_1" align="center" style={{ paddingBottom: 20 }} lg={6} md={12} sm={12} xs={12}>
            ...
            <p id="info">
              {' '}
              Screw the Review and experience something new! Screw the Review provides users with
              new experiences by generating activities based a set of filters. It utilizes
              Yelp to provide users with details of their new experience and Auth0 to
              provide account support for users.
              {' '}
            </p>
