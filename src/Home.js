          ...
          <Row className="align-items-center">
            ...
            <Col id="landing_col_1" align="center" style={{ paddingBottom: 20 }} lg={6} md={12} sm={12} xs={12}>
              ...
              <p id="info">
                ...
                Search generates an experience from filters like price, location and keyword.
                Spin the roulette wheel to receive a category and we`&#39;`ll pick a new experience
                from it!
              </p>
