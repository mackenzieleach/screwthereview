...
2. **[User Guide](https://github.com/mackenzieleach/screwthereview/wiki/Screw-the-Review:-User-Guide):** The user guide is intented for those who would like to utilize the Screw the Review application. It describes more about Screw the Review, how to use the features on the wesbite, how to report bugs and where to find the currently known bugs in the software. 
